...
const toolSeo: Partial<
  Record<Tool["slug"], { title: string; description: string }>
> = {
  "az-keyboard-fixer": {
    title: "Azərbaycan klaviatura düzəldici | AzToolbox",
    description:
      "m'n bel' yaz;ram tipli Azərbaycan klaviatura səhvlərini tez düzəldin.",
  },
  "az-transliteration": {
  ...
  "image-tools": {
    title:
      "Şəkil alətləri | Ölçüləndir, sıxışdır, CV şəkli hazırla | AzToolbox",
    description:
  ...
  "image-resizer": {
    ...
    description:
      "Şəkilləri sosial media, CV və profil ölçülərinə uyğun ölçüləndirin.",
  },
  "image-compressor": {
    title: "Şəkil sıxışdırıcı | AzToolbox",
    description:
      "Şəkil fayl ölçüsünü brauzerinizdə azaldın və yeni faylı yükləyin.",
  },
  "image-to-pdf": {
    title: "Şəkli PDF et | AzToolbox",
    description:
      "JPG, PNG və WEBP şəkilləri brauzerinizdə tək PDF faylına çevirin.",
  },
  "pdf-tools": {
  ...
  "cv-photo-maker": {
    ...
    description:
      "CV, LinkedIn və profil üçün kvadrat və 3x4 ölçüdə şəkil hazırlayın.",
  },
  "cv-builder": {
    title: "CV hazırlayıcı | Pulsuz PDF CV generator | AzToolbox",
    description:
      "Tələbələr və junior developer-lər üçün sadə, təmiz PDF CV hazırlayın.",
  },
  "linkedin-headline-generator": {
    title: "LinkedIn headline generator | AzToolbox",
    description:
      "AI API olmadan LinkedIn profiliniz üçün təmiz headline variantları yaradın.",
  },
  "whatsapp-link-generator": {
    title: "WhatsApp link generator | AzToolbox",
    description:
      "Nömrə və mesaj daxil edin, paylaşılabilən WhatsApp linki yaradın.",
  },
  "qr-code-generator": {
  ...
  "invoice-generator": {
    ...
    description:
      "Freelancer və kiçik bizneslər üçün brauzerdə sadə PDF qəbz yaradın.",
  },
  "vat-calculator": {
    title: "ƏDV kalkulyatoru | AzToolbox",
    description:
      "18% ƏDV əlavə edin və ya qiymətin içindən ƏDV məbləğini çıxarın.",
  },
  "discount-calculator": {
  ...
  "text-cleaner": {
    ...
    description:
      "Kopyalanmış qarışıq mətni qaydaya salın, boşluqları və formatı təmizləyin.",
  },
  "word-counter": {
